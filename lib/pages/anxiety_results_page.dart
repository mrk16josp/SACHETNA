...
class AnxietyResultsPage extends StatelessWidget {
  final int totalScore;
  final String anxietyType;
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 10),
            _getRecommendations(anxietyType),
            SizedBox(height: 20),
            ElevatedButton(
              onPressed: () {
                // Link to information about anxiety
                final snackBar = SnackBar(content: Text('Link to more information about anxiety will be available.'));
                ScaffoldMessenger.of(context).showSnackBar(snackBar);
              },
              child: Text("Know more about anxiety"),
  ...
  Widget _getRecommendations(String anxietyType) {
    switch (anxietyType) {
      case 'Severe Anxiety':
